...
public class CargarEdicion {
    public String cargarEdicion() {
        ...
        List <String> l7 = new ArrayString();
        l7.add("heisenberg");
        ...
        List <String> l8 = new ArrayString();
        l8.add("heisenberg");
        l8.add("benkenobi");
        ...
        List <String> l9 = new ArrayString();
        l9.add("benkenobi");
        l9.add("waston");
        ...
        List <String> l10 = new ArrayString();
        l10.add("waston");
        ...
        AltaEdicionCurso aec14 = new AltaEdicionCurso("Seminarios de Resolución de
        Problemas - 2019", "Seminarios de Resolución de Problemas",fInicio14,fFin14,0,fAlta14);
