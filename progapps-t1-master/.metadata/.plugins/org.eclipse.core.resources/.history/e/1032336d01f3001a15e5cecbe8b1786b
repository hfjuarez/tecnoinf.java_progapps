...
public class CargarCursos {
        public String cargarCursos() {
                ...
                AltaCurso ac3 = new AltaCurso("Dalavuelta",
                                "Dalavuelta es un proyecto de extension que nace en el Instituto de Ingenieria Mecanica y Produccion Industrial (IIMPI) de Fing, que, si bien inicia su trabajo en el desarrollo de bicicletas accesibles para personas en situacion de discapacidad motriz a partir de bicicletas abandonadas, se propuso diseñar otras herramientas para fomentar la accesibilidad.",
