...
public class CargarCursos {
        public String cargarCursos() {
                ...
                ret += ac2.createCurso("IMERL", l2,lc1);
                ...
                ret += ac3.createCurso("IMPII", l3,lc1);
                ...
                ret += ac4.createCurso("IMPII", l4,lc1);
                ...
                ret += ac5.createCurso("IMPII", l5,lc1);
                ...
                ret += ac6.createCurso("DISI", l6,lc1);
                ...
                ret += ac7.createCurso("INCO", l7,lc1);
                ...
                ret += ac8.createCurso("INCO", l8,lc1);
                ...
                ret += ac9.createCurso("INCO", l9,lc1);
                ...
                ret += ac10.createCurso("Electrica", l10,lc1);
